...
sections:
  - type: hero_section
    ...
    content: "Par où commencer ? Quelle solution choisir ? À qui faire appel ? Comment évaluer le prix et la qualité technique d'une offre ? Voilà **autant de questions qu'on se pose au démarrage d'un projet**. Votre Conseiller Numérique y répond, vous donne toutes les clés et l'assistance nécessaire à la réussite de votre projet digital \U0001F680\n"
    has_border: false
