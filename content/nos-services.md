...
sections:
  - type: hero_section
    ...
    content: "Par où commencer ? Quelle solution choisir ? Cet outil est-il vraiment adapté ? À qui faire appel ? Comment évaluer techniquement cette offre ? \n\nLe prix est-il justifié ? Voilà **autant de questions qu'on se pose souvent au démarrage d'un projet**. Le rôle de Votre Conseiller Numérique est justement d'y répondre. **Mettez toutes les chances de votre côté** pour réussir votre projet digital \U0001F3C6\n"
    has_border: false
