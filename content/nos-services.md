...
sections:
  - type: hero_section
    ...
    content: "Par où commencer ? À qui faire appel ? Quelle solution choisir ? Comment évaluer la qualité technique ? Le prix est-il justifié ? Voilà **autant de questions qu'on se pose au démarrage d'un projet**. Votre Conseiller Numérique répond à  vos questions, vous donne toutes les clés et l'assistance nécessaire à réussite de votre projet digital \U0001F680\n"
    has_border: false
