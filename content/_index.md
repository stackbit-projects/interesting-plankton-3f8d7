...
sections:
  - type: hero_section
    ...
    subtitle: "Besoin d'un avis expert, d'une assistance à la conception ou d'un accompagnement complet, notre réseau vous aide à réussir\_ \U0001F91D"
    actions:
      - type: action
        template: action
  ...
  - type: features_section
    ...
    features:
      ...
      - type: feature
        ...
        content: >
          Langages, librairies, frameworks, logiciels, solutions libres, cloud
          ou growth hacking. Nous analysons votre besoin et vous recommandons
  ...
  - type: grid_section
    ...
    subtitle: Un interlocuteur unique qui mobilise un large réseau d'expertises
    grid_items:
      - type: grid_item
        template: grid_item
        content: >
...
seo:
  ...
  description: >-
    ...
    site internet, e-commerce, application mobile
  extra:
    - name: 'og:type'
      value: website
      keyName: property
