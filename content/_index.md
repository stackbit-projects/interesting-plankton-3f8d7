...
sections:
  - type: hero_section
    ...
    subtitle: "Besoin d'un conseil ou d'être accompagné. Nous sommes-là pour vous aider ! \U0001F91D"
    actions:
      - type: action
        template: action
  ...
  - type: form_section
    ...
    form_fields:
      ...
      - type: form_field
        ...
        name: message
        label: Message
        default_value: Entrez votre message. Nous vous répondons au plus vite
      - type: form_field
        template: form_field
        input_type: checkbox
        name: consent
