...
sections:
  - type: hero_section
    ...
    subtitle: "Besoin d'un avis ou d'un accompagnement complet, un réseau d'experts au service de tous vos projets digitaux ! \U0001F64C️"
    actions:
      - type: action
        template: action
  ...
  - type: form_section
    ...
    content: >
      ...
      *   **Vous accompagner** pour en garantir la réussite.
      ...
      Contactez-nous dès à présent pour discuter de votre besoin ! Un conseiller
      expérimenté vous répondra rapidement.
    content_align: left
    form_position: right
    form_width: fifty
    form_layout: stacked
